...
POINT_CLOUD_REGISTER_POINT_STRUCT(velodyne_kitti::Point,
    (float, x, x)
    (float, y, y)
    (float, z, z)
    (float, intensity, intensity)
...
private:
  ...
  void velodyne_kitti_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg);
